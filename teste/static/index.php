									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												<div class="row">
													<div class="col mt-0">
														<h5 class="card-title">Quantidade de Ingressos</h5>
													</div>
													<?php 
										...
										<div class="card">
											<div class="card-body">
												<div class="row">
													...
													<!-- 
														$query_ingressos_vendidos = "SELECT SUM(PRODUTO_QTD) AS ingressos_vendidos FROM PRODUTO";
														$ingressos_vendidos = $pdo->prepare($query_ingressos_vendidos);
														$ingressos_vendidos->execute();
														$row_ingressos_vendidos = $ingressos_vendidos->fetch(PDO::FETCH_ASSOC);
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												<div class="row">
													<div class="col mt-0">
														<h5 class="card-title">Ingressos Disponíveis</h5>
													</div>
