    ...
    <div style="padding-left: 45%; padding-right: 10%;" class="container">
        ...
        <form id="formulario" class="row g-3 was-validated"  method="POST" action="autentificacao_adm.php">
            <div class="row g-3">
                ...
                <input class="form-control is-invalid" style="color: #FE185A;" id="validationFormEmail2" class="caixaemail" type="email" name="email"   id="email" placeholder="bravo4fun@bravo4fun.com" required>
            </div>
            <div class="row g-3">
                <label for="validationFormPassword1" class="form-label" class="senha">Senha:</label>
                <input class="form-control is-invalid" style="color:#FE185A;" id="validationFormPassword1" class="caixasenha" type="password" name="senha"   id="senha" placeholder="Amand@123" required>
            </div>
