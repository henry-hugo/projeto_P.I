...
<body>
      ...
      <Form Action="atualizar_produto.php" method="POST">
                ...
                <input type="text" name="imagem_url" class="form-control" required onchange='campobranco' value="<?php echo $imagem ?>">
                <label for="exampleFormControlInput1"  class="form-label">IMAGEM ORDEM</label>
                <input type="number" name="ordem" class="form-control" required onchange='campobranco' value="<?php echo $imagem_ordem ?>">
